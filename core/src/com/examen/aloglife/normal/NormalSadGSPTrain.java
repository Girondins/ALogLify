...
public class NormalSadGSPTrain extends ApplicationAdapter {
    ...
    public NormalSadGSPTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalHappyGSPTrain/normalGSP_color_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalHappyGSPTrain/normalGSP_color.json"));
        ...
        timer.schedule(new NormalSadGSPTrain.Animater(),2000);
