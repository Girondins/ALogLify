...
public class NormalHappyShoesnGlassesTrain extends ApplicationAdapter {
    ...
    public NormalHappyShoesnGlassesTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new NormalHappyShoesnGlassesTrain.Animater(),2000);
