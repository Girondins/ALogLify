...
/**
 * Created by Girondins on 2017-03-31.
 */

//TODO NOT IMP Check all
public class NormalSadShoesnGlassesTrain extends ApplicationAdapter {
    ...
    public NormalSadShoesnGlassesTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalHappyShoesnGlassesTrain/normal_shoes_color_glasses_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalHappyShoesnGlassesTrain/normal_shoes_color_glasses.json"));
        ...
        timer.schedule(new NormalSadShoesnGlassesTrain.Animater(),2000);
