...
public class NormalSadShoesTrain extends ApplicationAdapter {
    ...
    public NormalSadShoesTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalHappyShoesTrain/boggiNormalShoesColor_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalHappyShoesTrain/boggiNormalShoesColor.json"));
        ...
        timer.schedule(new NormalSadShoesTrain.Animater(),2000);
