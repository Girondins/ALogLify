...
public class NormalHappyShoesTrain extends ApplicationAdapter {
    ...
    public NormalHappyShoesTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new NormalHappyShoesTrain.Animater(),2000);
