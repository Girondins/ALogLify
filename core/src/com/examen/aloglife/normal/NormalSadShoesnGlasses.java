...
public class NormalSadShoesnGlasses extends ApplicationAdapter {
    ...
    public NormalSadShoesnGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalSadShoesnGlasses/boggisadshoesnglasses_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalSadShoesnGlasses/boggisadshoesnglasses.json"));
        ...
        timer.schedule(new NormalSadShoesnGlasses.Animater(),2000);
