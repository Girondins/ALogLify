...
public class NormalHappyGSPTrain extends ApplicationAdapter {
    ...
    public NormalHappyGSPTrain(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new NormalHappyGSPTrain.Animater(),2000);
