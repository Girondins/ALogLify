...
public class NormalHappyGlasses extends ApplicationAdapter {
    ...
    public NormalHappyGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalHappyGlasses/G-glasses_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalHappyGlasses/G-glasses.json"));
        ...
        timer.schedule(new NormalHappyGlasses.Animater(),2000);
