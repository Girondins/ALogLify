...
public class NormalHappyPhoneGlasses extends ApplicationAdapter{
    ...
    public NormalHappyPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalHappyPhoneGlasses/G-pho-glas_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.4f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalHappyPhoneGlasses/G-pho-glas.json"));
        ...
        stateData.setMix("Idle", "idle_bump", 0.2f);
        stateData.setMix("idle_bump", "Idle", 0.2f);
        ...
        timer.schedule(new NormalHappyPhoneGlasses.Animater(),2000);
            ...
            while (true) {
                switch (task) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        state.setAnimation(0, "idle_bump", false);
                        state.addAnimation(0, "Idle", true, 0);
