...
public class NormalSadPhoneGlasses extends ApplicationAdapter{
    ...
    public NormalSadPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalSadPhoneGlasses/sad_glasses_phone_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalSadPhoneGlasses/sad_glasses_phone.json"));
        ...
        timer.schedule(new NormalSadPhoneGlasses.Animater(),2000);
