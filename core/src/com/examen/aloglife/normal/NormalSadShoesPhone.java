...
public class NormalSadShoesPhone extends ApplicationAdapter{
    ...
    public NormalSadShoesPhone(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/normalSadShoePhone/sad_phone_shoes_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/normalSadShoePhone/sad_phone_shoes.json"));
        ...
        timer.schedule(new NormalSadShoesPhone.Animater(),2000);
