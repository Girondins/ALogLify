...
/**
 * Created by Girondins on 2017-03-24.
 */

public class Normal extends ApplicationAdapter{
    ...
    public Normal(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("normal/boggi_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("normal/boggi.json"));
     ...
     //   skeleton.setAttachment("body-bb","body_boundingBox");
       ...
       // state.addAnimation(0, "waveNormal", false, 2);
        ...
        timer.schedule(new Animater(),2000);
            ...
            while (true) {
                switch (task) {
                    case 0:
                        ...
                        state.setAnimation(0, "waveNormal", false);
                        state.addAnimation(0, "IdleNormal", true, 0);
                        break;
                    case 1:
                        ...
                        state.setAnimation(0, "walkNormal", false);
