...
public class XXLHappyPhoneGlasses extends ApplicationAdapter{
    ...
    public XXLHappyPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new XXLHappyPhoneGlasses.Animater(),2000);
