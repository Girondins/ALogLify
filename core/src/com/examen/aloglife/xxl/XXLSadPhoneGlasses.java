...
public class XXLSadPhoneGlasses extends ApplicationAdapter{
    ...
    public XXLSadPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new XXLSadPhoneGlasses.Animater(),2000);
