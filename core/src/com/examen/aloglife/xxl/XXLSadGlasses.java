package com.examen.aloglife.xxl;
...
public class XXLSadGlasses extends ApplicationAdapter{
    ...
    public XXLSadGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new XXLSadGlasses.Animater(),2000);
