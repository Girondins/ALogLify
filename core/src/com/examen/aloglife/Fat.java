...
/**
 * Created by Girondins on 2017-03-26.
 */

public class Fat extends ApplicationAdapter{
    ...
    public Fat(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("test/boggieFAT_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("test/boggieFAT.json"));
        ...
        state.setAnimation(0, "idleFat", true);
        ...
        timer.schedule(new Fat.Animater(),2000);
            ...
            public boolean touchDown (int screenX, int screenY, int pointer, int button) {
                ...
                if (bounds.aabbContainsPoint(point.x, point.y)) { // Check if inside AABB first. This check is fast.
                    ...
                    if (hit != null) {
                        ...
                        state.setAnimation(0, "jumpFat", false); // Set animation on track 0 to jump.
                        state.addAnimation(0, "idleFat", true, 0); // Queue run to play after jump.
                    }
                }
                return true;
            }
            ...
            while (true) {
                switch (task) {
                    case 0:
                        ...
                        state.setAnimation(0, "sitting", false);
                        state.addAnimation(0, "idleFat", true, 0);
                        break;
                    case 1:
                        ...
                        state.setAnimation(0, "walkingFAt", false);
