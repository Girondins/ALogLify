...
public class FatSadShoesnGlasses extends ApplicationAdapter {
    ...
    public FatSadShoesnGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatSadShoesnGlasses/boggieFatSad_glasses_shoes_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatSadShoesnGlasses/boggieFatSad_glasses_shoes.json"));
        ...
        timer.schedule(new FatSadShoesnGlasses.Animater(),2000);
