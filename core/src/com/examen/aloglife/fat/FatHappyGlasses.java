...
public class FatHappyGlasses extends ApplicationAdapter {
    ...
    public FatHappyGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new FatHappyGlasses.Animater(),2000);
