package com.examen.aloglife.fat;
...
public class FatHappyShoesPhone extends ApplicationAdapter{
    ...
    public FatHappyShoesPhone(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatHappyShoePhone/Fatshoephone_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatHappyShoePhone/Fatshoephone.json"));
        ...
        stateData.setMix("idle", "sitting", 0.2f);
        stateData.setMix("sitting", "idle", 0.2f);
        stateData.setMix("idle", "walk", 0.2f);
        stateData.setMix("walk", "idle", 0.2f);
        stateData.setMix("idle", "idleLookUp", 0.2f);
        stateData.setMix("idleLookUp", "idle", 0.2f);
        ...
        timer.schedule(new FatHappyShoesPhone.Animater(),2000);
            ...
            while (true) {
                switch (task) {
                    case 0:
                        ...
                        state.setAnimation(0, "idleLookUp", false);
