...
public class FatSadPhoneGlasses extends ApplicationAdapter{
    ...
    public FatSadPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new FatSadPhoneGlasses.Animater(),2000);
