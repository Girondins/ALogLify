...
public class FatHappyShoesnGlasses extends ApplicationAdapter {
    ...
    public FatHappyShoesnGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatHappyShoesnGlasses/FatGLASSES_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatHappyShoesnGlasses/FatGLASSES.json"));
        ...
        timer.schedule(new FatHappyShoesnGlasses.Animater(),2000);
