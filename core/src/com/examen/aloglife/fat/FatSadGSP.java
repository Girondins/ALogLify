...
public class FatSadGSP extends ApplicationAdapter {
    ...
    public FatSadGSP(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatSadGSP/boggieFatSad_all_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatSadGSP/boggieFatSad_all.json"));
        ...
        timer.schedule(new FatSadGSP.Animater(),2000);
