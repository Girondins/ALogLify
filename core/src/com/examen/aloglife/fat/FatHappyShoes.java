...
public class FatHappyShoes extends ApplicationAdapter{
    ...
    public FatHappyShoes(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatHappyShoes/Fat_shoes_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatHappyShoes/Fat_shoes.json"));
        ...
        stateData.setMix("idle", "walking", 0.2f);
        stateData.setMix("walking", "idle", 0.2f);
        ...
        timer.schedule(new FatHappyShoes.Animater(),2000);
            ...
            while (true) {
                switch (task) {
                    ...
                    case 1:
                        ...
                        state.setAnimation(0, "walking", false);
