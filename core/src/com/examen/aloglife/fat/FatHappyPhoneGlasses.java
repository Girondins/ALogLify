...
public class FatHappyPhoneGlasses extends ApplicationAdapter{
    ...
    public FatHappyPhoneGlasses(float centerX, float centerY){
    ...
    public void create () {
        ...
        timer.schedule(new FatHappyPhoneGlasses.Animater(),2000);
