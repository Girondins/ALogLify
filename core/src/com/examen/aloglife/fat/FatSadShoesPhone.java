...
public class FatSadShoesPhone extends ApplicationAdapter{
    ...
    public FatSadShoesPhone(float centerX, float centerY){
    ...
    public void create () {
        ...
        atlas = new TextureAtlas(Gdx.files.internal("fat/fatSadShoePhone/boggieFatSad_shoes_phone_tex.atlas"));
        SkeletonJson json = new SkeletonJson(atlas); // This loads skeleton JSON data, which is stateless.
        json.setScale(1.2f); // Load the skeleton at 50% the size it was in Spine.
        SkeletonData skeletonData = json.readSkeletonData(Gdx.files.internal("fat/fatSadShoePhone/boggieFatSad_shoes_phone.json"));
        ...
        timer.schedule(new FatSadShoesPhone.Animater(),2000);
